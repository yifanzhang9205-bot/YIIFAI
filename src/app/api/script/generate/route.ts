...
你的核心任务：根据用户需求创作一个**让观众停下滑动、完整看完、忍不住转发**的优质剧本。
...
返回JSON格式（严格遵守）：
{
  ...
  "scenes": [
    {
      "sceneNumber": 1,
      "location": "场景（具体地点，越具体越有代入感）",
      "timeOfDay": "时间（早晨/中午/傍晚/深夜）",
      "mood": "情绪氛围（如：压抑/温馨/紧张/浪漫，越具体越好）",
      "characters": ["角色名"],
      "action": "动作描述（必须画面感极强！要求：动词+细节+反转。如：他双手颤抖着拿起电话，屏幕的光映照着他布满血丝的眼睛，突然电话自动挂断，屏幕显示'对方已关机'）",
...
1. **场景结构**：20-30场，总时长120-180秒（2-3分钟完整短剧）
2. **开场场景**（sceneNumber: 1）必须有强烈视觉钩子，让人停下滑动
3. **每场反转**：每个场景都要有意外、冲突或情感转折
4. **视觉钩子**：每场的visualHook必须具体、震撼，让人"wow"一声
5. **动作描述**：必须有画面感，包含动词+细节，不能是"他想着"、"他感觉到"这种抽象描述
6. **情感弧线**：必须有起伏、转折，不能是一条直线
7. **结尾升华**：最后一场要有情感升华或震撼的反转
8. **直接返回JSON，不要包含任何额外的文字、注释或markdown代码块标记**

## 场景设计示例（参考）

**场景1（开场钩子）**：
- action: "深夜，他满头大汗，手里紧握着一张皱巴巴的诊断书，在暴雨中狂奔，突然脚下一滑，重重摔倒在水坑里"
- visualHook: "暴雨中摔倒的瞬间，诊断书飘落在地，特写显示'晚期'两个字"
- emotionalBeat: "从紧张到绝望"

**场景2（反转）**：
- action: "他颤抖着捡起诊断书，正要查看，一辆黑色轿车突然停在他面前，车窗摇下，露出他最不想见的人"
- visualHook: "黑色轿车大灯照亮他满脸的雨水和绝望的表情"
- emotionalBeat: "从绝望到更深的恐惧"

**场景3（意外）**：
- action: "车里的人递给他一把伞，他抬头一看，竟然是多年前不告而别的父亲，父亲满头白发，眼神充满愧疚"
- visualHook: "父子在暴雨中对视，雨水模糊了视线，但两人都看到对方眼里的泪水"
- emotionalBeat: "从恐惧到复杂情绪"
